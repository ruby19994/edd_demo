...
document.write("<input id=\"input\" type=\"text\" placeholder=\"Enter E-mail\" name=\"uname\" required>");
document.write("<h5 style=\"text-align:left;font-weight:bold;\">密碼</h5>");
document.write("<input type=\"password\" placeholder=\"Enter Password\" name=\"psw\" required>");
...
document.write("<input id=\"input\" type=\"text\" placeholder=\"Enter Username\" name=\"uname\" required>");
document.write("<h5 style=\"text-align:left;font-weight:bold;\">電子信箱</h5>");
document.write("<input type=\"password\" placeholder=\"Enter E-mail\" name=\"mail\" required>");
document.write("<h5 style=\"text-align:left;font-weight:bold;\">密碼</h5>");
document.write("<input type=\"password\" placeholder=\"Enter Password\" name=\"psw\" required>");
document.write("<h5 style=\"text-align:left;font-weight:bold;\">電話</h5>");
document.write("<input type=\"password\" placeholder=\"Enter Phone\" name=\"phone\" required>");
document.write("<h5 style=\"text-align:left;font-weight:bold;\">地址</h5>");
document.write("<input type=\"password\" placeholder=\"Enter Address\" name=\"address\" required>");
document.write("<button id=\"btn\" type=\"submit\">Signin</button>");
document.write("<label>");
document.write("<input type=\"checkbox\" checked=\"checked\" name=\"remember\"> Remember me</label></div>");
document.write("<div class=\"container\" style=\"background-color:#f1f1f1\">");
